...
define( 'NORWAYAPI_ENDPOINT', 'https://raisedbet-com.nwacdn.com/' );
define( 'OM_ENDPOINT', 'https://serverapi.everymatrix.com/' );
define( 'OM_TOKEN', 'upwadTQhtzs2xmcwF3SlRhNCBzn0VOfEjn3S5ToX' );
define('server_ip_1','10.3.56.16');
define('server_1_api_port',3008);
define('server_1_fe_port',3007);
define('server_ip_2','10.3.56.17');
define('server_2_api_port',3008);
define('server_2_fe_port',3007);
