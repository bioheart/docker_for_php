...
class Settings extends Base {
	...
	public function add_action_links( $links ) {
		...
		$links[] = sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://help.codexpert.io/?utm_source=free-plugins&utm_medium=help-link&utm_campaign=image-sizes', __( 'Help', 'woolementor' ) );
